...
class PaginaDeHospedagem : AppCompatActivity() {
    lateinit var binding: ActivityPaginaDeHospedagemBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPaginaDeHospedagemBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.btnVoltar6.setOnClickListener{
        ...
        recyclerView = binding.listaHoteis
